!(function(t) {
          ...
          b
            ? ((p = r(function(t, r, e, i) {
                ...
                if (w(r)) {
                  ...
                  } else if ((u = y(i) * n) + v > d) throw G("Wrong length!");
                  c = u / n;
            ...
            : (o(function() {
              ...
              H(m !== Function.prototype ? F(d).concat(F(m)) : F(d), function(
                t
              ) {
                t in p || h(p, t, d[t]);
              }),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      if (
        ...
        (b = y.getConstructor(n, t, g, x)), u(b.prototype, r), (c.NEED = !0);
      return (
        v(b, t),
        (S[t] = b),
        i(i.G + i.W + i.F * (b != m), S),
    ...
    t.exports = function(t, n, r, p, y, g, d) {
      ...
      if (
        (A &&
          ...
          x.next &&
          (a(x, S, !0), e || "function" == typeof x[l] || u(x, l, v)),
        _ &&
          F &&
          "values" !== F.name &&
          ((E = !0),
  ...
  function(t, n, r) {
    ...
    var e = document.getElementById("progress"),
      i = document.querySelector(".bg"),
      o = document.querySelector(".house"),
      u = document.querySelector(".karusel"),
      c = document.querySelector(".car"),
    ...
    var a = (function() {
      ...
      return function(n) {
        ...
        return (
          t[r] ||
            (t[r] = new Promise(function(i, o) {
              var u = n.length;
              if (0 === u) i();
              else
                for (
                  var c = function() {
                      var o = 1 - (u -= 1) / n.length;
                      (e.style.width = 100 * o + "%"),
                        0 === u && (i(), (t[r] = null));
                    },
                    f = 0;
                  ...
                  var a = new Image();
                  (a.onload = c), (a.onerror = c), (a.src = n[f]);
                }
            })),
          t[r]
        );
    ...
    function s() {
      ...
      (i.style.width = t + 200 + "px"), (i.style.height = n + "px");
    }
    ...
    var l = 30,
      ...
      d = [
        {
          element: i,
          translate: { small: "-60px", middle: "-80px" },
          transition: "0.9s ease"
        },
        {
          element: o,
          translate: { small: "-200px", middle: "-200px" },
          transition: "0.9s ease"
        },
        {
          element: u,
          translate: { small: "-100px", middle: "-100px" },
          transition: "0.9s ease"
        },
        {
          element: c,
          translate: { small: "-100px", middle: "-200px" },
          transition: "0.9s ease"
        },
        {
          element: f,
    ...
    function m() {
      d.map(function(t) {
        var n = window.innerWidth < 1400 ? "small" : "middle",
          r = t.translate[n];
        (t.element.style.transform = "translate(" + r + ", 0)"),
          t.transition && (t.element.style.transition = t.transition);
      });
    }
    function b(t) {
        ...
        switch (
          (function(t, n) {
            if (-1 !== g.x) {
              ...
              if (!(Math.abs(r) < l))
                return r > 0 && p !== h && !y
                  ? ((g = { x: t, y: n, diff: r }), (p = h))
                  : r < 0 && p !== v && !y
                    ? ((g = { x: t, y: n, diff: r }), (p = v))
                    : void (r > 0 && p === h
                        ? (g = { x: t, y: n })
                        : r < 0 && p === v && (g = { x: t, y: n }));
            } else g = { x: t, y: n };
          ...
          case v:
            y ||
              (d.map(function(t) {
                t.element.style.transform = "translate(0, 0)";
              }),
              (y = setTimeout(function() {
                y = null;
              }, 900)));
  ...
  function(t, n, r) {
    ...
    var e = r(2),
      ...
      H = function(t) {
        ...
        return (
          !(this === B && i(C, t) && !i(W, t)) &&
          (!(n || !i(this, t) || !i(C, t) || (i(this, L) && this[L][t])) || n)
        );
      },
      X = function(t, n) {
        if (((t = x(t)), (n = w(n, !0)), t !== B || !i(C, n) || i(W, n))) {
          var r = M(t, n);
          return (
            !r || !i(C, n) || (i(t, L) && t[L][n]) || (r.enumerable = !0), r
          );
        }
      },
      Z = function(t) {
        for (var n, r = j(x(t)), e = [], o = 0; r.length > o; )
          i(C, (n = r[o++])) || n == L || n == f || e.push(n);
        return e;
      },
      $ = function(t) {
        for (
          var n, r = t === B, e = j(r ? W : x(t)), o = [], u = 0;
          e.length > u;

        )
          !i(C, (n = e[u++])) || (r && !i(B, n)) || o.push(C[n]);
        return o;
      };
    U ||
      (c(
        (I = function() {
          ...
          return o && G && z(B, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        "toString",
        function() {
          return this._k;
    ...
    u(u.S + u.F * !U, "Symbol", {
      ...
      I.prototype[k] || r(13)(I.prototype, k, I.prototype.valueOf),
      l(I, "Symbol"),
      l(Math, "Math", !0),
      l(e.JSON, "JSON", !0);
  },
  ...
  function(t, n, r) {
    ...
    if (!v(" 0o1") || !v("0b1") || v("+0x1")) {
      ...
      (v.prototype = y), (y.constructor = v), r(10)(e, "Number", v);
    }
  },
  function(t, n, r) {
    "use strict";
      ...
      "Array",
      {
        from: function(t) {
          var n,
            ...
            m = s(h);
          if (
            (g && (y = e(y, p > 2 ? arguments[2] : void 0, 2)),
            void 0 == m || (v == Array && c(m)))
          )
            for (r = new v((n = f(h.length))); n > d; d++)
              a(r, d, g ? y(h[d], d) : h[d]);
          else
            for (l = m.call(h), r = new v(); !(i = l.next()).done; d++)
              a(r, d, g ? u(l, y, [i.value, d], !0) : i.value);
          return (r.length = d), r;
        }
      }
    );
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      m = (t.exports = r(54)("WeakMap", g, d, f, !0, !0));
    s(function() {
      return 7 != new m().set((Object.freeze || Object)(y), 7).get(y);
    }) &&
      (c((e = f.getConstructor(g, "WeakMap")).prototype, d),
      (u.NEED = !0),
